...
public class RuleList 
{
    ...
    private Rule[] rules;
    private final int NUM_RULES = 112;
    ...
    private void fillList() 
    {
        ...
        rules[71] = new Rule(72, "Stasgn", "Varspec equal Stasgn_tail");
        ...
        rules[110] = new Rule(111, "Stasgn_tail", "Expr");
        rules[111] = new Rule(112, "Stasgn_tail", "kwdinput parens1 Kind parens2");
